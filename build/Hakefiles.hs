...
(".//lib/virtio/Hakefile", (let find fn arg = (fn allfiles ".//lib/virtio/Hakefile" arg) in
Rules ((let build a = (buildFunction a) allfiles ".//lib/virtio/Hakefile" a in
{-# LINE 1 "..//lib/virtio/Hakefile" #-}
...
in [ build library {
   target = "sys",
   addCFlags  = Config.newlibAddCFlags,
   cFiles     = [ "syscalls.c" , "findfp.c" , "posix_syscalls.c", "lock.c"]
                ++ malloc_files,
 omitCFlags   = [ "-Wmissing-prototypes",
                  "-Wmissing-declarations",
                  "-Wimplicit-function-declaration",
...
(".//lib/newlib/newlib/libc/machine/Hakefile", (let find fn arg = (fn allfiles ".//lib/newlib/newlib/libc/machine/Hakefile" arg) in
Rules ((let build a = (buildFunction a) allfiles ".//lib/newlib/newlib/libc/machine/Hakefile" a in
{-# LINE 1 "..//lib/newlib/newlib/libc/machine/Hakefile" #-}
if Config.libc == "newlib" then
let
...
(".//lib/lua/Hakefile", (let find fn arg = (fn allfiles ".//lib/lua/Hakefile" arg) in
Rules ((let build a = (buildFunction a) allfiles ".//lib/lua/Hakefile" a in
{-# LINE 1 "..//lib/lua/Hakefile" #-}
--------------------------------------------------------------------------
...
(".//lib/xeon_phi/Hakefile", (let find fn arg = (fn allfiles ".//lib/xeon_phi/Hakefile" arg) in
Rules ((let build a = (buildFunction a) allfiles ".//lib/xeon_phi/Hakefile" a in
{-# LINE 1 "..//lib/xeon_phi/Hakefile" #-}
...
(".//lib/net_interfaces/Hakefile", (let find fn arg = (fn allfiles ".//lib/net_interfaces/Hakefile" arg) in
Rules ((let build a = (buildFunction a) allfiles ".//lib/net_interfaces/Hakefile" a in
{-# LINE 1 "..//lib/net_interfaces/Hakefile" #-}
--------------------------------------------------------------------------
-- Copyright (c) 2007-2012, ETH Zurich.
-- All rights reserved.
--
...
(".//lib/bitmap/Hakefile", (let find fn arg = (fn allfiles ".//lib/bitmap/Hakefile" arg) in
Rules ((let build a = (buildFunction a) allfiles ".//lib/bitmap/Hakefile" a in
{-# LINE 1 "..//lib/bitmap/Hakefile" #-}
--------------------------------------------------------------------------
...
(".//lib/numa/Hakefile", (let find fn arg = (fn allfiles ".//lib/numa/Hakefile" arg) in
Rules ((let build a = (buildFunction a) allfiles ".//lib/numa/Hakefile" a in
{-# LINE 1 "..//lib/numa/Hakefile" #-}
--------------------------------------------------------------------------
-- Copyright (c) 2014, ETH Zurich.
-- All rights reserved.
--
...
(".//lib/bulk_transfer/Hakefile", (let find fn arg = (fn allfiles ".//lib/bulk_transfer/Hakefile" arg) in
Rules ((let build a = (buildFunction a) allfiles ".//lib/bulk_transfer/Hakefile" a in
{-# LINE 1 "..//lib/bulk_transfer/Hakefile" #-}
--------------------------------------------------------------------------
-- Copyright (c) 2013, ETH Zurich.
-- All rights reserved.
--
...
(".//lib/dma/Hakefile", (let find fn arg = (fn allfiles ".//lib/dma/Hakefile" arg) in
Rules ((let build a = (buildFunction a) allfiles ".//lib/dma/Hakefile" a in
{-# LINE 1 "..//lib/dma/Hakefile" #-}
...
(".//lib/bomp_new/Hakefile", (let find fn arg = (fn allfiles ".//lib/bomp_new/Hakefile" arg) in
Rules ((let build a = (buildFunction a) allfiles ".//lib/bomp_new/Hakefile" a in
{-# LINE 1 "..//lib/bomp_new/Hakefile" #-}
--------------------------------------------------------------------------
-- Copyright (c) 2007-2009, ETH Zurich.
-- All rights reserved.
--
...
(".//lib/arranet/Hakefile", (let find fn arg = (fn allfiles ".//lib/arranet/Hakefile" arg) in
Rules ((let build a = (buildFunction a) allfiles ".//lib/arranet/Hakefile" a in
{-# LINE 1 "..//lib/arranet/Hakefile" #-}
--------------------------------------------------------------------------
-- Copyright (c) 2007-2009, 2011, 2012, 2013, ETH Zurich.
-- All rights reserved.
--
...
(".//doc/018-Practical-guide/Hakefile", (let find fn arg = (fn allfiles ".//doc/018-Practical-guide/Hakefile" arg) in
Rules ((let build a = (buildFunction a) allfiles ".//doc/018-Practical-guide/Hakefile" a in
{-# LINE 1 "..//doc/018-Practical-guide/Hakefile" #-}
----------------------------------------------------------------------
...
[ buildTechNote "Overview.tex" "TN-000-Overview.pdf" True False
                    [ "cap_heirarchy", 
                      "cap_translation",
                      "dcb", 
                      "os-arch" ] 
...
(".//doc/017-arm/Hakefile", (let find fn arg = (fn allfiles ".//doc/017-arm/Hakefile" arg) in
Rules ((let build a = (buildFunction a) allfiles ".//doc/017-arm/Hakefile" a in
{-# LINE 1 "..//doc/017-arm/Hakefile" #-}
----------------------------------------------------------------------
-- Copyright (c) 2013, ETH Zurich.
-- All rights reserved.
--
...
(".//doc/019-device-drivers/Hakefile", (let find fn arg = (fn allfiles ".//doc/019-device-drivers/Hakefile" arg) in
Rules ((let build a = (buildFunction a) allfiles ".//doc/019-device-drivers/Hakefile" a in
{-# LINE 1 "..//doc/019-device-drivers/Hakefile" #-}
----------------------------------------------------------------------
-- Copyright (c) 2013, ETH Zurich.
-- All rights reserved.
--
...
(".//tools/weever/Hakefile", (let find fn arg = (fn allfiles ".//tools/weever/Hakefile" arg) in
Rules ((let build a = (buildFunction a) allfiles ".//tools/weever/Hakefile" a in
{-# LINE 1 "..//tools/weever/Hakefile" #-}
----------------------------------------------------------------------
-- Copyright (c) 2009, 2010, ETH Zurich.
-- All rights reserved.
--
...
(".//tools/weever/multiboot/Hakefile", (let find fn arg = (fn allfiles ".//tools/weever/multiboot/Hakefile" arg) in
Rules ((let build a = (buildFunction a) allfiles ".//tools/weever/multiboot/Hakefile" a in
{-# LINE 1 "..//tools/weever/multiboot/Hakefile" #-}
----------------------------------------------------------------------
-- Copyright (c) 2009, 2010, ETH Zurich.
-- All rights reserved.
--
...
(".//tools/weever/creator/Hakefile", (let find fn arg = (fn allfiles ".//tools/weever/creator/Hakefile" arg) in
Rules ((let build a = (buildFunction a) allfiles ".//tools/weever/creator/Hakefile" a in
{-# LINE 1 "..//tools/weever/creator/Hakefile" #-}
----------------------------------------------------------------------
-- Copyright (c) 2009, 2010, ETH Zurich.
-- All rights reserved.
--
...
(".//usr/bulk_transfer_passthrough/Hakefile", (let find fn arg = (fn allfiles ".//usr/bulk_transfer_passthrough/Hakefile" arg) in
Rules ((let build a = (buildFunction a) allfiles ".//usr/bulk_transfer_passthrough/Hakefile" a in
{-# LINE 1 "..//usr/bulk_transfer_passthrough/Hakefile" #-}
--------------------------------------------------------------------------
-- Copyright (c) 2007-2010, ETH Zurich.
-- All rights reserved.
--
...
(".//usr/periodicprint/Hakefile", (let find fn arg = (fn allfiles ".//usr/periodicprint/Hakefile" arg) in
Rules ((let build a = (buildFunction a) allfiles ".//usr/periodicprint/Hakefile" a in
{-# LINE 1 "..//usr/periodicprint/Hakefile" #-}
--------------------------------------------------------------------------
-- Copyright (c) 2014, ETH Zurich.
-- All rights reserved.
--
...
-- ETH Zurich D-INFK, Universitaetstr 6, CH-8092 Zurich. Attn: Systems Group.
--
-- Hakefile for periodicprint
-- 
--------------------------------------------------------------------------

[ build application { target = "periodicprint",
                      addLibraries = [ "bench" ],
                      cFiles = [ "printperiodic.c" ] }
]
)))),
...
(".//usr/block_server_user/Hakefile", (let find fn arg = (fn allfiles ".//usr/block_server_user/Hakefile" arg) in
Rules ((let build a = (buildFunction a) allfiles ".//usr/block_server_user/Hakefile" a in
{-# LINE 1 "..//usr/block_server_user/Hakefile" #-}
--------------------------------------------------------------------------
-- Copyright (c) 2007-2010, ETH Zurich.
-- All rights reserved.
--
...
(".//usr/tracectrl/Hakefile", (let find fn arg = (fn allfiles ".//usr/tracectrl/Hakefile" arg) in
Rules ((let build a = (buildFunction a) allfiles ".//usr/tracectrl/Hakefile" a in
{-# LINE 1 "..//usr/tracectrl/Hakefile" #-}
--------------------------------------------------------------------------
-- Copyright (c) 2013, ETH Zurich.
-- All rights reserved.
--
...
(".//usr/drivers/omap44xx/sdma/Hakefile", (let find fn arg = (fn allfiles ".//usr/drivers/omap44xx/sdma/Hakefile" arg) in
Rules ((let build a = (buildFunction a) allfiles ".//usr/drivers/omap44xx/sdma/Hakefile" a in
{-# LINE 1 "..//usr/drivers/omap44xx/sdma/Hakefile" #-}
--------------------------------------------------------------------------
...
(".//usr/drivers/virtio/console/Hakefile", (let find fn arg = (fn allfiles ".//usr/drivers/virtio/console/Hakefile" arg) in
Rules ((let build a = (buildFunction a) allfiles ".//usr/drivers/virtio/console/Hakefile" a in
{-# LINE 1 "..//usr/drivers/virtio/console/Hakefile" #-}
--------------------------------------------------------------------------
-- Copyright (c) 2007-2010, ETH Zurich.
-- All rights reserved.
--
...
(".//usr/drivers/virtio/net/Hakefile", (let find fn arg = (fn allfiles ".//usr/drivers/virtio/net/Hakefile" arg) in
Rules ((let build a = (buildFunction a) allfiles ".//usr/drivers/virtio/net/Hakefile" a in
{-# LINE 1 "..//usr/drivers/virtio/net/Hakefile" #-}
--------------------------------------------------------------------------
-- Copyright (c) 2007-2010, ETH Zurich.
-- All rights reserved.
--
...
(".//usr/drivers/virtio/block/Hakefile", (let find fn arg = (fn allfiles ".//usr/drivers/virtio/block/Hakefile" arg) in
Rules ((let build a = (buildFunction a) allfiles ".//usr/drivers/virtio/block/Hakefile" a in
{-# LINE 1 "..//usr/drivers/virtio/block/Hakefile" #-}
--------------------------------------------------------------------------
-- Copyright (c) 2007-2010, ETH Zurich.
-- All rights reserved.
--
...
[ build application { target = "e1000n",
  ...
  build library { target = "e1000n",
                      cFiles = [ "e1000n.c", "e1000n_hwinit.c", "e1000n_helpers.c" ],
                      flounderDefs = [ "octopus", "net_queue_manager" ],
                      mackerelDevices = [ "e1000" ],
...
(".//usr/drivers/solarflair/Hakefile", (let find fn arg = (fn allfiles ".//usr/drivers/solarflair/Hakefile" arg) in
Rules ((let build a = (buildFunction a) allfiles ".//usr/drivers/solarflair/Hakefile" a in
{-# LINE 1 "..//usr/drivers/solarflair/Hakefile" #-}
--------------------------------------------------------------------------
-- Copyright (c) 2007-2009, 2011, ETH Zurich.
-- All rights reserved.
--
...
(".//usr/drivers/ioat_dma/Hakefile", (let find fn arg = (fn allfiles ".//usr/drivers/ioat_dma/Hakefile" arg) in
Rules ((let build a = (buildFunction a) allfiles ".//usr/drivers/ioat_dma/Hakefile" a in
{-# LINE 1 "..//usr/drivers/ioat_dma/Hakefile" #-}
--------------------------------------------------------------------------
-- Copyright (c) 2014, ETH Zurich.
-- All rights reserved.
--
...
(".//usr/drivers/xeon_phi/Hakefile", (let find fn arg = (fn allfiles ".//usr/drivers/xeon_phi/Hakefile" arg) in
Rules ((let build a = (buildFunction a) allfiles ".//usr/drivers/xeon_phi/Hakefile" a in
{-# LINE 1 "..//usr/drivers/xeon_phi/Hakefile" #-}
--------------------------------------------------------------------------
-- Copyright (c) 2007-2010, ETH Zurich.
-- All rights reserved.
--
...
(".//usr/drivers/lo/Hakefile", (let find fn arg = (fn allfiles ".//usr/drivers/lo/Hakefile" arg) in
Rules ((let build a = (buildFunction a) allfiles ".//usr/drivers/lo/Hakefile" a in
{-# LINE 1 "..//usr/drivers/lo/Hakefile" #-}
--------------------------------------------------------------------------
-- Copyright (c) 2007-2012, ETH Zurich.
-- All rights reserved.
--
...
(".//usr/drivers/cpuboot/Hakefile", (let find fn arg = (fn allfiles ".//usr/drivers/cpuboot/Hakefile" arg) in
Rules ((let build a = (buildFunction a) allfiles ".//usr/drivers/cpuboot/Hakefile" a in
{-# LINE 1 "..//usr/drivers/cpuboot/Hakefile" #-}
--------------------------------------------------------------------------
-- Copyright (c) 2013, ETH Zurich.
-- All rights reserved.
--
...
[ build application { target = "e10k_queue",
  ...
  build library { target = "e10k",
                      ...
                      flounderDefs = [  "net_queue_manager", "e10k_vf" ],
...
(".//usr/examples/xmpl-cow/Hakefile", (let find fn arg = (fn allfiles ".//usr/examples/xmpl-cow/Hakefile" arg) in
Rules ((let build a = (buildFunction a) allfiles ".//usr/examples/xmpl-cow/Hakefile" a in
{-# LINE 1 "..//usr/examples/xmpl-cow/Hakefile" #-}
--------------------------------------------------------------------------
-- Copyright (c) 2007-2010, ETH Zurich.
-- All rights reserved.
--
...
[ build application { target = "examples/xmpl-cow",
                      cFiles = [ "main.c" ]
                    }
]
)))),
...
(".//usr/device_managers/xeon_phi/Hakefile", (let find fn arg = (fn allfiles ".//usr/device_managers/xeon_phi/Hakefile" arg) in
Rules ((let build a = (buildFunction a) allfiles ".//usr/device_managers/xeon_phi/Hakefile" a in
{-# LINE 1 "..//usr/device_managers/xeon_phi/Hakefile" #-}
--------------------------------------------------------------------------
-- Copyright (c) 2007-2009, ETH Zurich.
-- All rights reserved.
--
...
(".//usr/device_managers/dma/Hakefile", (let find fn arg = (fn allfiles ".//usr/device_managers/dma/Hakefile" arg) in
Rules ((let build a = (buildFunction a) allfiles ".//usr/device_managers/dma/Hakefile" a in
{-# LINE 1 "..//usr/device_managers/dma/Hakefile" #-}
--------------------------------------------------------------------------
-- Copyright (c) 2014, ETH Zurich.
-- All rights reserved.
--
...
(".//usr/block_server/Hakefile", (let find fn arg = (fn allfiles ".//usr/block_server/Hakefile" arg) in
Rules ((let build a = (buildFunction a) allfiles ".//usr/block_server/Hakefile" a in
{-# LINE 1 "..//usr/block_server/Hakefile" #-}
--------------------------------------------------------------------------
-- Copyright (c) 2007-2010, ETH Zurich.
-- All rights reserved.
--
...
(".//usr/arrakismon/Hakefile", (let find fn arg = (fn allfiles ".//usr/arrakismon/Hakefile" arg) in
Rules ((let build a = (buildFunction a) allfiles ".//usr/arrakismon/Hakefile" a in
{-# LINE 1 "..//usr/arrakismon/Hakefile" #-}
--------------------------------------------------------------------------
...
[ 
  ...
  build application { target = "fish",
                      ...
                      addLibraries = libDeps ["trace", "skb", "pci", "vfs", "acpi_client", "lwip", "octopus" ],
...
(".//usr/tests/dma_test/Hakefile", (let find fn arg = (fn allfiles ".//usr/tests/dma_test/Hakefile" arg) in
Rules ((let build a = (buildFunction a) allfiles ".//usr/tests/dma_test/Hakefile" a in
{-# LINE 1 "..//usr/tests/dma_test/Hakefile" #-}
--------------------------------------------------------------------------
-- Copyright (c) 2014, ETH Zurich.
-- All rights reserved.
--
...
-- ETH Zurich D-INFK, Universitaetsstrasse 6, CH-8092 Zurich. Attn: Systems Group.
--
-- Hakefile for /usr/test/dmatest
--
--------------------------------------------------------------------------

[ build application { 
	target = "tests/dma_test",
	architectures = [ 
	   "x86_64",
	   "k1om"
	],
	...
	addLibraries = libDeps [  "dma_client" ]
  }  
]
)))),
(".//usr/tests/lua/Hakefile", (let find fn arg = (fn allfiles ".//usr/tests/lua/Hakefile" arg) in
Rules ((let build a = (buildFunction a) allfiles ".//usr/tests/lua/Hakefile" a in
{-# LINE 1 "..//usr/tests/lua/Hakefile" #-}
--------------------------------------------------------------------------
-- Copyright (c) 2013, ETH Zurich.
-- All rights reserved.
--
...
[
    build application {
        target = "tests/luatest",
        cFiles = (find withSuffices [".c"]),
        addLibraries = libDeps ["lua"]
    }
])))),
...
(".//usr/tests/net-test/Hakefile", (let find fn arg = (fn allfiles ".//usr/tests/net-test/Hakefile" arg) in
Rules ((let build a = (buildFunction a) allfiles ".//usr/tests/net-test/Hakefile" a in
{-# LINE 1 "..//usr/tests/net-test/Hakefile" #-}
--------------------------------------------------------------------------
-- Copyright (c) 2007-2010, ETH Zurich.
-- All rights reserved.
--
...
(".//usr/tests/phoenix_tests/Hakefile", (let find fn arg = (fn allfiles ".//usr/tests/phoenix_tests/Hakefile" arg) in
Rules ((let build a = (buildFunction a) allfiles ".//usr/tests/phoenix_tests/Hakefile" a in
{-# LINE 1 "..//usr/tests/phoenix_tests/Hakefile" #-}
--------------------------------------------------------------------------
-- Copyright (c) 2007-2010, ETH Zurich.
-- All rights reserved.
--
...
(".//usr/tests/xeon_phi_test/Hakefile", (let find fn arg = (fn allfiles ".//usr/tests/xeon_phi_test/Hakefile" arg) in
Rules ((let build a = (buildFunction a) allfiles ".//usr/tests/xeon_phi_test/Hakefile" a in
{-# LINE 1 "..//usr/tests/xeon_phi_test/Hakefile" #-}
--------------------------------------------------------------------------
-- Copyright (c) 2007-2009, ETH Zurich.
-- All rights reserved.
--
...
[ build application { 
  ...
  build application { 
    target = "tests/xphi_nameservice_test",
    architectures = [ 
      "k1om",
      "x86_64"
    ],
...
(".//usr/tests/xomptest/Hakefile", (let find fn arg = (fn allfiles ".//usr/tests/xomptest/Hakefile" arg) in
Rules ((let build a = (buildFunction a) allfiles ".//usr/tests/xomptest/Hakefile" a in
{-# LINE 1 "..//usr/tests/xomptest/Hakefile" #-}
--------------------------------------------------------------------------
-- Copyright (c) 2007-2009, ETH Zurich.
-- All rights reserved.
--
...
(".//usr/tests/sdmatest/Hakefile", (let find fn arg = (fn allfiles ".//usr/tests/sdmatest/Hakefile" arg) in
Rules ((let build a = (buildFunction a) allfiles ".//usr/tests/sdmatest/Hakefile" a in
{-# LINE 1 "..//usr/tests/sdmatest/Hakefile" #-}
--------------------------------------------------------------------------
-- Copyright (c) 2007-2014, ETH Zurich.
-- All rights reserved.
--
...
(".//usr/tests/posixcompat/Hakefile", (let find fn arg = (fn allfiles ".//usr/tests/posixcompat/Hakefile" arg) in
Rules ((let build a = (buildFunction a) allfiles ".//usr/tests/posixcompat/Hakefile" a in
{-# LINE 1 "..//usr/tests/posixcompat/Hakefile" #-}
--------------------------------------------------------------------------
-- Copyright (c) 2014, ETH Zurich.
-- All rights reserved.
--
...
(".//usr/tests/numa/Hakefile", (let find fn arg = (fn allfiles ".//usr/tests/numa/Hakefile" arg) in
Rules ((let build a = (buildFunction a) allfiles ".//usr/tests/numa/Hakefile" a in
{-# LINE 1 "..//usr/tests/numa/Hakefile" #-}
--------------------------------------------------------------------------
-- Copyright (c) 2013, ETH Zurich.
-- All rights reserved.
--
...
(".//usr/tests/wakeuptests/Hakefile", (let find fn arg = (fn allfiles ".//usr/tests/wakeuptests/Hakefile" arg) in
Rules ((let build a = (buildFunction a) allfiles ".//usr/tests/wakeuptests/Hakefile" a in
{-# LINE 1 "..//usr/tests/wakeuptests/Hakefile" #-}
--------------------------------------------------------------------------
-- Copyright (c) 2014, ETH Zurich.
-- All rights reserved.
--
...
-- ETH Zurich D-INFK, Universitaetsstr. 6, CH-8092 Zurich. Attn: Systems Group.
--
-- Hakefile for /usr/tests/wakeuptests
-- 
--------------------------------------------------------------------------

[ build application { target = "wakeuptest",
                      cFiles = [ "wakeuptest.c" ],
                      addLibraries = [ "bench" ]
                    }
]
...
(".//usr/tests/bulk_transfer/Hakefile", (let find fn arg = (fn allfiles ".//usr/tests/bulk_transfer/Hakefile" arg) in
Rules ((let build a = (buildFunction a) allfiles ".//usr/tests/bulk_transfer/Hakefile" a in
{-# LINE 1 "..//usr/tests/bulk_transfer/Hakefile" #-}
--------------------------------------------------------------------------
-- Copyright (c) 2014, ETH Zurich.
-- All rights reserved.
--
...
(".//usr/tests/flounderbootstrap/Hakefile", (let find fn arg = (fn allfiles ".//usr/tests/flounderbootstrap/Hakefile" arg) in
Rules ((let build a = (buildFunction a) allfiles ".//usr/tests/flounderbootstrap/Hakefile" a in
{-# LINE 1 "..//usr/tests/flounderbootstrap/Hakefile" #-}
--------------------------------------------------------------------------
-- Copyright (c) 2007-2010, ETH Zurich.
-- All rights reserved.
--
...
[
build application { target = "flounderbootstraptest",
                  cFiles = [ "flounderbootstrap.c" ],
                  flounderBindings = [ "flounderbootstrap" ]
                 }
]
)))),
...
(".//usr/tests/e10ktest/Hakefile", (let find fn arg = (fn allfiles ".//usr/tests/e10ktest/Hakefile" arg) in
Rules ((let build a = (buildFunction a) allfiles ".//usr/tests/e10ktest/Hakefile" a in
{-# LINE 1 "..//usr/tests/e10ktest/Hakefile" #-}
--------------------------------------------------------------------------
-- Copyright (c) 2007-2011, 2013, ETH Zurich.
-- All rights reserved.
--
...
(".//usr/tests/posix/Hakefile", (let find fn arg = (fn allfiles ".//usr/tests/posix/Hakefile" arg) in
Rules ((let build a = (buildFunction a) allfiles ".//usr/tests/posix/Hakefile" a in
{-# LINE 1 "..//usr/tests/posix/Hakefile" #-}
--------------------------------------------------------------------------
-- Copyright (c) 2007-2009, 2013, ETH Zurich.
-- All rights reserved.
--
...
(".//usr/myapp/Hakefile", (let find fn arg = (fn allfiles ".//usr/myapp/Hakefile" arg) in
Rules ((let build a = (buildFunction a) allfiles ".//usr/myapp/Hakefile" a in
{-# LINE 1 "..//usr/myapp/Hakefile" #-}
[build application { target = "myapp",
                      cFiles = [ "myapp.c" ]
                    }
]
...
(".//usr/bench/mem_latency/Hakefile", (let find fn arg = (fn allfiles ".//usr/bench/mem_latency/Hakefile" arg) in
Rules ((let build a = (buildFunction a) allfiles ".//usr/bench/mem_latency/Hakefile" a in
{-# LINE 1 "..//usr/bench/mem_latency/Hakefile" #-}
--------------------------------------------------------------------------
-- Copyright (c) 2007-2010, ETH Zurich.
-- All rights reserved.
--
...
(".//usr/bench/bomp_mm/Hakefile", (let find fn arg = (fn allfiles ".//usr/bench/bomp_mm/Hakefile" arg) in
Rules ((let build a = (buildFunction a) allfiles ".//usr/bench/bomp_mm/Hakefile" a in
{-# LINE 1 "..//usr/bench/bomp_mm/Hakefile" #-}
--------------------------------------------------------------------------
-- Copyright (c) 2007-2010, ETH Zurich.
-- All rights reserved.
--
...
(".//usr/bench/xomp_bench/Hakefile", (let find fn arg = (fn allfiles ".//usr/bench/xomp_bench/Hakefile" arg) in
Rules ((let build a = (buildFunction a) allfiles ".//usr/bench/xomp_bench/Hakefile" a in
{-# LINE 1 "..//usr/bench/xomp_bench/Hakefile" #-}
--------------------------------------------------------------------------
-- Copyright (c) 2007-2010, ETH Zurich.
-- All rights reserved.
--
...
(".//usr/bench/rcce/lu/Hakefile", (let find fn arg = (fn allfiles ".//usr/bench/rcce/lu/Hakefile" arg) in
Rules ((let build a = (buildFunction a) allfiles ".//usr/bench/rcce/lu/Hakefile" a in
{-# LINE 1 "..//usr/bench/rcce/lu/Hakefile" #-}
--------------------------------------------------------------------------
-- Copyright (c) 2007-2010, ETH Zurich.
-- All rights reserved.
--
...
(".//usr/bench/rcce/ipi_test/Hakefile", (let find fn arg = (fn allfiles ".//usr/bench/rcce/ipi_test/Hakefile" arg) in
Rules ((let build a = (buildFunction a) allfiles ".//usr/bench/rcce/ipi_test/Hakefile" a in
{-# LINE 1 "..//usr/bench/rcce/ipi_test/Hakefile" #-}
--------------------------------------------------------------------------
-- Copyright (c) 2007-2010, ETH Zurich.
-- All rights reserved.
--
...
(".//usr/bench/rcce/pingpong/Hakefile", (let find fn arg = (fn allfiles ".//usr/bench/rcce/pingpong/Hakefile" arg) in
Rules ((let build a = (buildFunction a) allfiles ".//usr/bench/rcce/pingpong/Hakefile" a in
{-# LINE 1 "..//usr/bench/rcce/pingpong/Hakefile" #-}
--------------------------------------------------------------------------
-- Copyright (c) 2007-2010, ETH Zurich.
-- All rights reserved.
--
...
(".//usr/bench/rcce/bt/Hakefile", (let find fn arg = (fn allfiles ".//usr/bench/rcce/bt/Hakefile" arg) in
Rules ((let build a = (buildFunction a) allfiles ".//usr/bench/rcce/bt/Hakefile" a in
{-# LINE 1 "..//usr/bench/rcce/bt/Hakefile" #-}
--------------------------------------------------------------------------
-- Copyright (c) 2007-2010, ETH Zurich.
-- All rights reserved.
--
...
(".//usr/bench/bomp_benchmark/Hakefile", (let find fn arg = (fn allfiles ".//usr/bench/bomp_benchmark/Hakefile" arg) in
Rules ((let build a = (buildFunction a) allfiles ".//usr/bench/bomp_benchmark/Hakefile" a in
{-# LINE 1 "..//usr/bench/bomp_benchmark/Hakefile" #-}
--------------------------------------------------------------------------
-- Copyright (c) 2007-2009, ETH Zurich.
-- All rights reserved.
--
...
(".//usr/bench/xeon_phi_ump/Hakefile", (let find fn arg = (fn allfiles ".//usr/bench/xeon_phi_ump/Hakefile" arg) in
Rules ((let build a = (buildFunction a) allfiles ".//usr/bench/xeon_phi_ump/Hakefile" a in
{-# LINE 1 "..//usr/bench/xeon_phi_ump/Hakefile" #-}
--------------------------------------------------------------------------
-- Copyright (c) 2007-2009, ETH Zurich.
-- All rights reserved.
--
...
(".//usr/bench/udp_echo/Hakefile", (let find fn arg = (fn allfiles ".//usr/bench/udp_echo/Hakefile" arg) in
Rules ((let build a = (buildFunction a) allfiles ".//usr/bench/udp_echo/Hakefile" a in
{-# LINE 1 "..//usr/bench/udp_echo/Hakefile" #-}
--------------------------------------------------------------------------
-- Copyright (c) 2007-2011, 2013, ETH Zurich.
-- All rights reserved.
--
...
(".//usr/bench/net_latency/Hakefile", (let find fn arg = (fn allfiles ".//usr/bench/net_latency/Hakefile" arg) in
Rules ((let build a = (buildFunction a) allfiles ".//usr/bench/net_latency/Hakefile" a in
{-# LINE 1 "..//usr/bench/net_latency/Hakefile" #-}
--------------------------------------------------------------------------
-- Copyright (c) 2007-2010, ETH Zurich.
-- All rights reserved.
--
...
(".//usr/bench/net_latency/elb/Hakefile", (let find fn arg = (fn allfiles ".//usr/bench/net_latency/elb/Hakefile" arg) in
Rules ((let build a = (buildFunction a) allfiles ".//usr/bench/net_latency/elb/Hakefile" a in
{-# LINE 1 "..//usr/bench/net_latency/elb/Hakefile" #-}
--------------------------------------------------------------------------
-- Copyright (c) 2007-2012, ETH Zurich.
-- All rights reserved.
--
...
(".//usr/bench/bulk_transfer/Hakefile", (let find fn arg = (fn allfiles ".//usr/bench/bulk_transfer/Hakefile" arg) in
Rules ((let build a = (buildFunction a) allfiles ".//usr/bench/bulk_transfer/Hakefile" a in
{-# LINE 1 "..//usr/bench/bulk_transfer/Hakefile" #-}
--------------------------------------------------------------------------
-- Copyright (c) 2014, ETH Zurich.
-- All rights reserved.
--
...
(".//usr/bench/vspace/Hakefile", (let find fn arg = (fn allfiles ".//usr/bench/vspace/Hakefile" arg) in
Rules ((let build a = (buildFunction a) allfiles ".//usr/bench/vspace/Hakefile" a in
{-# LINE 1 "..//usr/bench/vspace/Hakefile" #-}
--------------------------------------------------------------------------
-- Copyright (c) 2007-2010, ETH Zurich.
-- All rights reserved.
--
...
(".//usr/bench/dma/Hakefile", (let find fn arg = (fn allfiles ".//usr/bench/dma/Hakefile" arg) in
Rules ((let build a = (buildFunction a) allfiles ".//usr/bench/dma/Hakefile" a in
{-# LINE 1 "..//usr/bench/dma/Hakefile" #-}
--------------------------------------------------------------------------
-- Copyright (c) 2014, ETH Zurich.
-- All rights reserved.
--
...
-- ETH Zurich D-INFK, Universitaetsstrasse 6, CH-8092 Zurich. Attn: Systems Group.
--
-- Hakefile for /usr/benchmarks/dma_bench
--
--------------------------------------------------------------------------

[ build application { 
	target = "benchmarks/dma_bench",
	cFiles = [ 
	     "dma_bench.c"                    
	],
	addLibraries = libDeps [ 
...
(".//usr/bench/loopy/Hakefile", (let find fn arg = (fn allfiles ".//usr/bench/loopy/Hakefile" arg) in
Rules ((let build a = (buildFunction a) allfiles ".//usr/bench/loopy/Hakefile" a in
{-# LINE 1 "..//usr/bench/loopy/Hakefile" #-}
--------------------------------------------------------------------------
-- Copyright (c) 2014, ETH Zurich.
-- All rights reserved.
--
...
(".//usr/bench/bulk_sdma/Hakefile", (let find fn arg = (fn allfiles ".//usr/bench/bulk_sdma/Hakefile" arg) in
Rules ((let build a = (buildFunction a) allfiles ".//usr/bench/bulk_sdma/Hakefile" a in
{-# LINE 1 "..//usr/bench/bulk_sdma/Hakefile" #-}
--------------------------------------------------------------------------
-- Copyright (c) 2007-2013, ETH Zurich.
-- All rights reserved.
--
...
(".//usr/bench/sdma_bench/Hakefile", (let find fn arg = (fn allfiles ".//usr/bench/sdma_bench/Hakefile" arg) in
Rules ((let build a = (buildFunction a) allfiles ".//usr/bench/sdma_bench/Hakefile" a in
{-# LINE 1 "..//usr/bench/sdma_bench/Hakefile" #-}
--------------------------------------------------------------------------
-- Copyright (c) 2007-2014, ETH Zurich.
-- All rights reserved.
--
