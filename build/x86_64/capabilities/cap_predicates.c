...
bool is_ancestor(struct  capability* child,struct  capability* parent) {
    bool _fof_x192;
    genpaddr_t _fof_x193;
    genpaddr_t _fof_x194;
    gensize_t _fof_x195;
    gensize_t _fof_x196;
    struct  capability* child__186;
    struct  capability child__186__187;
    enum objtype child__186__187__190;
    struct  capability* parent__188;
    struct  capability parent__188__189;
    enum objtype parent__188__189__191;
 
    child__186 = child;
    child__186__187 = *child__186;
    parent__188 = parent;
    parent__188__189 = *parent__188;
    child__186__187__190 = child__186__187.type;
    parent__188__189__191 = parent__188__189.type;
    _fof_x192 = is_well_founded(parent__188__189__191,child__186__187__190);
    if ((! _fof_x192)){
        return (0);
    } else {
    }
    _fof_x193 = get_address(parent);
    _fof_x194 = get_address(child);
    _fof_x195 = get_size(parent);
    _fof_x196 = get_size(child);
    if ((child__186__187__190 == parent__188__189__191)){
        return ((((_fof_x193 < _fof_x194) & ((_fof_x193 + _fof_x195) >= (_fof_x194 + _fof_x196))) | ((_fof_x193 <= _fof_x194) & ((_fof_x193 + _fof_x195) > (_fof_x194 + _fof_x196)))));
    } else {
        return (((_fof_x193 <= _fof_x194) & ((_fof_x193 + _fof_x195) >= (_fof_x194 + _fof_x196))));
    }
}
 
bool is_copy(struct  capability* left,struct  capability* right) {
    int8_t _fof_x185;
    struct  capability* left__179;
    struct  capability left__179__180;
    enum objtype left__179__180__183;
    struct  capability* right__181;
    struct  capability right__181__182;
    enum objtype right__181__182__184;
 
    left__179 = left;
    left__179__180 = *left__179;
    right__181 = right;
    right__181__182 = *right__181;
    left__179__180__183 = left__179__180.type;
    right__181__182__184 = right__181__182.type;
    if ((left__179__180__183 != right__181__182__184)){
        return (0);
    } else {
    }
    switch (left__179__180__183) {
        case ObjType_IPI: {
            return (1);
            break;
        }
    ...
    _fof_x185 = compare_caps(left,right,0);
    return ((_fof_x185 == 0));
}
...
bool is_revoked_first(struct cte * src_cte,enum objtype src_type) {
    ...
    switch (src_type) {
        case ObjType_DevFrame: {
            _fof_x178 = has_descendants(src_cte);
            if (_fof_x178){
                return (0);
            } else {
                return (1);
        ...
        case ObjType_Frame: {
            _fof_x177 = has_descendants(src_cte);
            if (_fof_x177){
                return (0);
            } else {
                return (1);
        ...
        case ObjType_RAM: {
            _fof_x176 = has_descendants(src_cte);
            if (_fof_x176){
                return (0);
            } else {
                return (1);
        ...
        case ObjType_PhysAddr: {
            _fof_x175 = has_descendants(src_cte);
            if (_fof_x175){
                return (0);
            } else {
                return (1);
