 ...
 */
 errval_t mem_accept(struct mem_frameinfo *_frameinfo, void *st, mem_bind_continuation_fn *_continuation, struct waitset *ws, idc_export_flags_t flags)
{
    #ifdef CONFIG_FLOUNDER_BACKEND_UMP
    return(mem_ump_accept(_frameinfo, st, _continuation, ws, flags));
    #else
 ...
 errval_t mem_bind(iref_t iref, mem_bind_continuation_fn *_continuation, void *st, struct waitset *waitset, idc_bind_flags_t flags)
{
 ...
 errval_t mem_connect(struct mem_frameinfo *_frameinfo, mem_bind_continuation_fn *_continuation, void *st, struct waitset *ws, idc_bind_flags_t flags)
{
    #ifdef CONFIG_FLOUNDER_BACKEND_UMP
    return(mem_ump_connect(_frameinfo, _continuation, st, ws, flags));
    #else
    assert(!("UMP backend not enabled!"));
    return(ERR_NOTIMP);
    #endif // CONFIG_FLOUNDER_BACKEND_UMP
...
static  void mem_allocate_response__lmp_send_handler(void *arg)
{
    ...
    switch (_binding->tx_msg_fragment) {
    case 0:
        err = lmp_chan_send2(&(b->chan), (b->flags) | LMP_FLAG_GIVEAWAY, ((_binding->tx_union).allocate_response).mem_cap, mem_allocate_response__msgnum, ((_binding->tx_union).allocate_response).ret);
        if (err_is_ok(err)) {
            _binding->tx_msgnum = 0;
            flounder_support_trigger_chan(&(_binding->tx_cont_chanstate));
            flounder_support_trigger_chan(&(_binding->register_chanstate));
...
static  void mem_steal_response__lmp_send_handler(void *arg)
{
    ...
    switch (_binding->tx_msg_fragment) {
    case 0:
        err = lmp_chan_send2(&(b->chan), (b->flags) | LMP_FLAG_GIVEAWAY, ((_binding->tx_union).steal_response).mem_cap, mem_steal_response__msgnum, ((_binding->tx_union).steal_response).ret);
        if (err_is_ok(err)) {
            _binding->tx_msgnum = 0;
            flounder_support_trigger_chan(&(_binding->tx_cont_chanstate));
            flounder_support_trigger_chan(&(_binding->register_chanstate));
...
static  void mem_free_monitor_call__lmp_send_handler(void *arg)
{
    ...
    switch (_binding->tx_msg_fragment) {
    case 0:
        err = lmp_chan_send2(&(b->chan), (b->flags) | LMP_FLAG_GIVEAWAY, ((_binding->tx_union).free_monitor_call).mem_cap, mem_free_monitor_call__msgnum | (((uintptr_t )(((_binding->tx_union).free_monitor_call).bits)) << 16), ((_binding->tx_union).free_monitor_call).base);
        if (err_is_ok(err)) {
            _binding->tx_msgnum = 0;
            flounder_support_trigger_chan(&(_binding->tx_cont_chanstate));
            flounder_support_trigger_chan(&(_binding->register_chanstate));
...
static  errval_t mem_ump_tx_bind_msg(void *arg)
{
    // Get the binding state from our argument pointer
    struct mem_binding *_binding = arg;
    struct mem_ump_binding *b = arg;
    ...
    // send the next fragment
    msg = ump_chan_get_next(&((&(b->ump_state))->chan), &ctrl);
    flounder_stub_ump_control_fill(&(b->ump_state), &ctrl, mem___bind__msgnum);
...
static  errval_t mem_ump_tx_bind_reply(void *arg)
{
    // Get the binding state from our argument pointer
    struct mem_binding *_binding = arg;
    struct mem_ump_binding *b = arg;
    ...
    // send the next fragment
    msg = ump_chan_get_next(&((&(b->ump_state))->chan), &ctrl);
    flounder_stub_ump_control_fill(&(b->ump_state), &ctrl, mem___bind_reply__msgnum);
    (msg->data)[0] = 0xcafebabe;
    flounder_stub_ump_barrier();
    (msg->header).control = ctrl;
    _binding->tx_msgnum = 0;
 ...
 * Functions to accept/connect over a already shared frame
 */
 errval_t mem_ump_accept(struct mem_frameinfo *_frameinfo, void *st, mem_bind_continuation_fn *_continuation, struct waitset *ws, idc_export_flags_t flags)
{
    errval_t err;
 ...
 errval_t mem_ump_connect(struct mem_frameinfo *_frameinfo, mem_bind_continuation_fn *_continuation, void *st, struct waitset *ws, idc_bind_flags_t flags)
{
    errval_t err;
    // allocate storage for binding
    struct mem_ump_binding *b = malloc(sizeof(struct mem_ump_binding ));
