...
static  errval_t pci_reregister_interrupt__rpc(struct pci_rpc_client *_rpc, uint32_t class_code, uint32_t sub_class, uint32_t prog_if, uint32_t vendor_id, uint32_t device_id, uint32_t bus, uint32_t dev, uint32_t fun, uint8_t coreid, uint32_t vector, pci_errval_t *err)
{
    errval_t _err = SYS_ERR_OK;
    assert(!(_rpc->rpc_in_progress));
    assert((_rpc->async_error) == SYS_ERR_OK);
    ...
    // call send function
    _err = ((((_rpc->b)->tx_vtbl).reregister_interrupt_call)(_rpc->b, NOP_CONT, class_code, sub_class, prog_if, vendor_id, device_id, bus, dev, fun, coreid, vector));
    if (err_is_fail(_err)) {
        goto out;
    }
    ...
    // grab reply variables out of binding
    struct pci_binding *_binding = _rpc->b;
    *err = (((_binding->rx_union).reregister_interrupt_response).err);
...
static  errval_t pci_read_conf_header__rpc(struct pci_rpc_client *_rpc, uint32_t dword, pci_errval_t *err, uint32_t *val)
{
    errval_t _err = SYS_ERR_OK;
    assert(!(_rpc->rpc_in_progress));
    assert((_rpc->async_error) == SYS_ERR_OK);
    ...
    // call send function
    _err = ((((_rpc->b)->tx_vtbl).read_conf_header_call)(_rpc->b, NOP_CONT, dword));
    if (err_is_fail(_err)) {
        goto out;
    }
    ...
    // grab reply variables out of binding
    struct pci_binding *_binding = _rpc->b;
    *err = (((_binding->rx_union).read_conf_header_response).err);
    *val = (((_binding->rx_union).read_conf_header_response).val);
...
static  errval_t pci_write_conf_header__rpc(struct pci_rpc_client *_rpc, uint32_t dword, uint32_t val, pci_errval_t *err)
{
    errval_t _err = SYS_ERR_OK;
    assert(!(_rpc->rpc_in_progress));
    assert((_rpc->async_error) == SYS_ERR_OK);
    ...
    // call send function
    _err = ((((_rpc->b)->tx_vtbl).write_conf_header_call)(_rpc->b, NOP_CONT, dword, val));
    if (err_is_fail(_err)) {
        goto out;
    }
    ...
    // grab reply variables out of binding
    struct pci_binding *_binding = _rpc->b;
    *err = (((_binding->rx_union).write_conf_header_response).err);
...
static  errval_t pci_msix_enable__rpc(struct pci_rpc_client *_rpc, pci_errval_t *err, uint16_t *vec_count)
{
    errval_t _err = SYS_ERR_OK;
    assert(!(_rpc->rpc_in_progress));
    assert((_rpc->async_error) == SYS_ERR_OK);
    ...
    // call send function
    _err = ((((_rpc->b)->tx_vtbl).msix_enable_call)(_rpc->b, NOP_CONT));
    if (err_is_fail(_err)) {
        goto out;
    }
    ...
    // grab reply variables out of binding
    struct pci_binding *_binding = _rpc->b;
    *err = (((_binding->rx_union).msix_enable_response).err);
    *vec_count = (((_binding->rx_union).msix_enable_response).vec_count);
...
static  errval_t pci_msix_vector_init__rpc(struct pci_rpc_client *_rpc, uint16_t idx, uint8_t destination, uint8_t vector, pci_errval_t *err)
{
    errval_t _err = SYS_ERR_OK;
    assert(!(_rpc->rpc_in_progress));
    assert((_rpc->async_error) == SYS_ERR_OK);
    ...
    // call send function
    _err = ((((_rpc->b)->tx_vtbl).msix_vector_init_call)(_rpc->b, NOP_CONT, idx, destination, vector));
    if (err_is_fail(_err)) {
        goto out;
    }
    ...
    // grab reply variables out of binding
    struct pci_binding *_binding = _rpc->b;
    *err = (((_binding->rx_union).msix_vector_init_response).err);
...
static  void pci_reregister_interrupt__rpc_rx_handler(struct pci_binding *_binding, pci_errval_t err)
{
    // get RPC client state pointer
    struct pci_rpc_client *_rpc = _binding->st;
    ...
    // XXX: stash reply parameters in binding object
    // depending on the interconnect driver, they're probably already there
    ((_binding->rx_union).reregister_interrupt_response).err = err;
    
    // notify RPC function, and we're done
    _rpc->reply_present = true;
}

static  void pci_read_conf_header__rpc_rx_handler(struct pci_binding *_binding, pci_errval_t err, uint32_t val)
{
    // get RPC client state pointer
    struct pci_rpc_client *_rpc = _binding->st;
    ...
    // XXX: stash reply parameters in binding object
    // depending on the interconnect driver, they're probably already there
    ((_binding->rx_union).read_conf_header_response).err = err;
    ((_binding->rx_union).read_conf_header_response).val = val;
    
    // notify RPC function, and we're done
    _rpc->reply_present = true;
}

static  void pci_write_conf_header__rpc_rx_handler(struct pci_binding *_binding, pci_errval_t err)
{
    // get RPC client state pointer
    struct pci_rpc_client *_rpc = _binding->st;
    ...
    // XXX: stash reply parameters in binding object
    // depending on the interconnect driver, they're probably already there
    ((_binding->rx_union).write_conf_header_response).err = err;
    
    // notify RPC function, and we're done
    _rpc->reply_present = true;
}

static  void pci_msix_enable__rpc_rx_handler(struct pci_binding *_binding, pci_errval_t err, uint16_t vec_count)
{
    // get RPC client state pointer
    struct pci_rpc_client *_rpc = _binding->st;
    ...
    // XXX: stash reply parameters in binding object
    // depending on the interconnect driver, they're probably already there
    ((_binding->rx_union).msix_enable_response).err = err;
    ((_binding->rx_union).msix_enable_response).vec_count = vec_count;
    
    // notify RPC function, and we're done
    _rpc->reply_present = true;
}

static  void pci_msix_vector_init__rpc_rx_handler(struct pci_binding *_binding, pci_errval_t err)
{
    // get RPC client state pointer
    struct pci_rpc_client *_rpc = _binding->st;
    ...
    // XXX: stash reply parameters in binding object
    // depending on the interconnect driver, they're probably already there
    ((_binding->rx_union).msix_vector_init_response).err = err;
...
static  struct pci_rpc_vtbl pci_rpc_vtbl = {
    ...
    .reregister_interrupt = pci_reregister_interrupt__rpc,
    .read_conf_header = pci_read_conf_header__rpc,
    .write_conf_header = pci_write_conf_header__rpc,
    .msix_enable = pci_msix_enable__rpc,
    .msix_vector_init = pci_msix_vector_init__rpc,
};
 ...
 errval_t pci_rpc_client_init(struct pci_rpc_client *rpc, struct pci_binding *binding)
{
    ...
    (binding->rx_vtbl).reregister_interrupt_response = pci_reregister_interrupt__rpc_rx_handler;
    (binding->rx_vtbl).read_conf_header_response = pci_read_conf_header__rpc_rx_handler;
    (binding->rx_vtbl).write_conf_header_response = pci_write_conf_header__rpc_rx_handler;
    (binding->rx_vtbl).msix_enable_response = pci_msix_enable__rpc_rx_handler;
    (binding->rx_vtbl).msix_vector_init_response = pci_msix_vector_init__rpc_rx_handler;
