...
typedef enum mem_msg_enum {
    ...
    mem___bind__msgnum = 1,
    mem___bind_reply__msgnum = 2,
    mem_allocate_call__msgnum = 3,
    mem_allocate_response__msgnum = 4,
    mem_steal_call__msgnum = 5,
    mem_steal_response__msgnum = 6,
    mem_available_call__msgnum = 7,
    mem_available_response__msgnum = 8,
    mem_free_monitor_call__msgnum = 9,
    mem_free_monitor_response__msgnum = 10
} mem_msg_enum;
 ...
 */
extern  errval_t mem_accept(struct mem_frameinfo *_frameinfo, void *st, mem_bind_continuation_fn *_continuation, struct waitset *ws, idc_export_flags_t flags);
 ...
 */
extern  errval_t mem_connect(struct mem_frameinfo *_frameinfo, mem_bind_continuation_fn *_continuation, void *st, struct waitset *ws, idc_bind_flags_t flags);
