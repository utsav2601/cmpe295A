...
typedef enum xmplmsg_msg_enum {
    ...
    xmplmsg___bind__msgnum = 1,
    xmplmsg___bind_reply__msgnum = 2,
    xmplmsg_msg_ints__msgnum = 3,
    xmplmsg_msg_string__msgnum = 4
} xmplmsg_msg_enum;
 ...
 */
extern  errval_t xmplmsg_accept(struct xmplmsg_frameinfo *_frameinfo, void *st, xmplmsg_bind_continuation_fn *_continuation, struct waitset *ws, idc_export_flags_t flags);
 ...
 */
extern  errval_t xmplmsg_connect(struct xmplmsg_frameinfo *_frameinfo, xmplmsg_bind_continuation_fn *_continuation, void *st, struct waitset *ws, idc_bind_flags_t flags);
