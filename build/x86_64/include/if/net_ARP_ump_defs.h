...
extern  errval_t net_ARP_ump_accept(struct net_ARP_frameinfo *_frameinfo, void *st, net_ARP_bind_continuation_fn *_continuation, struct waitset *ws, idc_export_flags_t flags);
extern  errval_t net_ARP_ump_connect(struct net_ARP_frameinfo *_frameinfo, net_ARP_bind_continuation_fn *_continuation, void *st, struct waitset *ws, idc_bind_flags_t flags);
