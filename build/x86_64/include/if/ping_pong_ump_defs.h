...
extern  errval_t ping_pong_ump_accept(struct ping_pong_frameinfo *_frameinfo, void *st, ping_pong_bind_continuation_fn *_continuation, struct waitset *ws, idc_export_flags_t flags);
extern  errval_t ping_pong_ump_connect(struct ping_pong_frameinfo *_frameinfo, ping_pong_bind_continuation_fn *_continuation, void *st, struct waitset *ws, idc_bind_flags_t flags);
