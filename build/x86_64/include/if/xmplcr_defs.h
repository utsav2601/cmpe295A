...
typedef enum xmplcr_msg_enum {
    ...
    xmplcr___bind__msgnum = 1,
    xmplcr___bind_reply__msgnum = 2,
    xmplcr_mycall__msgnum = 3,
    xmplcr_myresponse__msgnum = 4
} xmplcr_msg_enum;
 ...
 */
extern  errval_t xmplcr_accept(struct xmplcr_frameinfo *_frameinfo, void *st, xmplcr_bind_continuation_fn *_continuation, struct waitset *ws, idc_export_flags_t flags);
 ...
 */
extern  errval_t xmplcr_connect(struct xmplcr_frameinfo *_frameinfo, xmplcr_bind_continuation_fn *_continuation, void *st, struct waitset *ws, idc_bind_flags_t flags);
