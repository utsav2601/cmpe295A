...
typedef enum empty_msg_enum {
    ...
    empty___bind__msgnum = 1,
    empty___bind_reply__msgnum = 2,
    empty_unused__msgnum = 3
} empty_msg_enum;
 ...
 */
extern  errval_t empty_accept(struct empty_frameinfo *_frameinfo, void *st, empty_bind_continuation_fn *_continuation, struct waitset *ws, idc_export_flags_t flags);
 ...
 */
extern  errval_t empty_connect(struct empty_frameinfo *_frameinfo, empty_bind_continuation_fn *_continuation, void *st, struct waitset *ws, idc_bind_flags_t flags);
