...
typedef enum mouse_msg_enum {
    ...
    mouse___bind__msgnum = 1,
    mouse___bind_reply__msgnum = 2,
    mouse_mouse_event__msgnum = 3
} mouse_msg_enum;
 ...
 */
extern  errval_t mouse_accept(struct mouse_frameinfo *_frameinfo, void *st, mouse_bind_continuation_fn *_continuation, struct waitset *ws, idc_export_flags_t flags);
 ...
 */
extern  errval_t mouse_connect(struct mouse_frameinfo *_frameinfo, mouse_bind_continuation_fn *_continuation, void *st, struct waitset *ws, idc_bind_flags_t flags);
