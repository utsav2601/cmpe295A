...
typedef enum hpet_msg_enum {
    ...
    hpet___bind__msgnum = 1,
    hpet___bind_reply__msgnum = 2,
    hpet_counter_request__msgnum = 3,
    hpet_counter_reply__msgnum = 4
} hpet_msg_enum;
 ...
 */
extern  errval_t hpet_accept(struct hpet_frameinfo *_frameinfo, void *st, hpet_bind_continuation_fn *_continuation, struct waitset *ws, idc_export_flags_t flags);
 ...
 */
extern  errval_t hpet_connect(struct hpet_frameinfo *_frameinfo, hpet_bind_continuation_fn *_continuation, void *st, struct waitset *ws, idc_bind_flags_t flags);
