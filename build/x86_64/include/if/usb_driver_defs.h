...
typedef enum usb_driver_msg_enum {
    ...
    usb_driver___bind__msgnum = 1,
    usb_driver___bind_reply__msgnum = 2,
    usb_driver_device_detach_notify__msgnum = 3,
    usb_driver_transfer_done_notify__msgnum = 4
} usb_driver_msg_enum;
 ...
 */
extern  errval_t usb_driver_accept(struct usb_driver_frameinfo *_frameinfo, void *st, usb_driver_bind_continuation_fn *_continuation, struct waitset *ws, idc_export_flags_t flags);
 ...
 */
extern  errval_t usb_driver_connect(struct usb_driver_frameinfo *_frameinfo, usb_driver_bind_continuation_fn *_continuation, void *st, struct waitset *ws, idc_bind_flags_t flags);
