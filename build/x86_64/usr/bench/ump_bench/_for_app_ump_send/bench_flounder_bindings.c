 ...
 */
 errval_t bench_accept(struct bench_frameinfo *_frameinfo, void *st, bench_bind_continuation_fn *_continuation, struct waitset *ws, idc_export_flags_t flags)
{
    #ifdef CONFIG_FLOUNDER_BACKEND_UMP
    return(bench_ump_accept(_frameinfo, st, _continuation, ws, flags));
    #else
 ...
 errval_t bench_bind(iref_t iref, bench_bind_continuation_fn *_continuation, void *st, struct waitset *waitset, idc_bind_flags_t flags)
{
 ...
 errval_t bench_connect(struct bench_frameinfo *_frameinfo, bench_bind_continuation_fn *_continuation, void *st, struct waitset *ws, idc_bind_flags_t flags)
{
    #ifdef CONFIG_FLOUNDER_BACKEND_UMP
    return(bench_ump_connect(_frameinfo, _continuation, st, ws, flags));
    #else
    assert(!("UMP backend not enabled!"));
    return(ERR_NOTIMP);
    #endif // CONFIG_FLOUNDER_BACKEND_UMP
...
static  errval_t bench_ump_tx_bind_msg(void *arg)
{
    // Get the binding state from our argument pointer
    struct bench_binding *_binding = arg;
    struct bench_ump_binding *b = arg;
    ...
    // send the next fragment
    msg = ump_chan_get_next(&((&(b->ump_state))->chan), &ctrl);
    flounder_stub_ump_control_fill(&(b->ump_state), &ctrl, bench___bind__msgnum);
...
static  errval_t bench_ump_tx_bind_reply(void *arg)
{
    // Get the binding state from our argument pointer
    struct bench_binding *_binding = arg;
    struct bench_ump_binding *b = arg;
    ...
    // send the next fragment
    msg = ump_chan_get_next(&((&(b->ump_state))->chan), &ctrl);
    flounder_stub_ump_control_fill(&(b->ump_state), &ctrl, bench___bind_reply__msgnum);
    (msg->data)[0] = 0xcafebabe;
    flounder_stub_ump_barrier();
    (msg->header).control = ctrl;
    _binding->tx_msgnum = 0;
 ...
 * Functions to accept/connect over a already shared frame
 */
 errval_t bench_ump_accept(struct bench_frameinfo *_frameinfo, void *st, bench_bind_continuation_fn *_continuation, struct waitset *ws, idc_export_flags_t flags)
{
    errval_t err;
 ...
 errval_t bench_ump_connect(struct bench_frameinfo *_frameinfo, bench_bind_continuation_fn *_continuation, void *st, struct waitset *ws, idc_bind_flags_t flags)
{
    errval_t err;
    // allocate storage for binding
    struct bench_ump_binding *b = malloc(sizeof(struct bench_ump_binding ));
    ...
    return(bench_ump_tx_bind_msg(b));
}
