...
static  errval_t monitor_boot_core_request__loopback_send(struct monitor_binding *_binding, struct event_closure _continuation, uint8_t id, struct capref frame)
{
    // call rx handler
    assert(((_binding->rx_vtbl).boot_core_request) != NULL);
    ((_binding->rx_vtbl).boot_core_request)(_binding, id, frame);
...
static  errval_t monitor_cap_send_request__loopback_send(struct monitor_binding *_binding, struct event_closure _continuation, uintptr_t mon_id, struct capref cap, monitor_capid_t_t capid)
{
    // call rx handler
    assert(((_binding->rx_vtbl).cap_send_request) != NULL);
    ((_binding->rx_vtbl).cap_send_request)(_binding, mon_id, cap, capid);
...
static  errval_t monitor_cap_move_request__loopback_send(struct monitor_binding *_binding, struct event_closure _continuation, uintptr_t mon_id, struct capref cap, monitor_capid_t_t capid)
{
    // call rx handler
    assert(((_binding->rx_vtbl).cap_move_request) != NULL);
    ((_binding->rx_vtbl).cap_move_request)(_binding, mon_id, cap, capid);
...
static  errval_t monitor_migrate_dispatcher_request__loopback_send(struct monitor_binding *_binding, struct event_closure _continuation, uint8_t core_id, struct capref vroot, struct capref disp)
{
    // call rx handler
    assert(((_binding->rx_vtbl).migrate_dispatcher_request) != NULL);
    ((_binding->rx_vtbl).migrate_dispatcher_request)(_binding, core_id, vroot, disp);
...
static  errval_t monitor_migrate_dispatcher__loopback_send(struct monitor_binding *_binding, struct event_closure _continuation, uintptr_t domain_id)
{
    // call rx handler
    assert(((_binding->rx_vtbl).migrate_dispatcher) != NULL);
    ((_binding->rx_vtbl).migrate_dispatcher)(_binding, domain_id);
...
static  struct monitor_tx_vtbl monitor_loopback_tx_vtbl = {
    ...
    .cap_move_request = monitor_cap_move_request__loopback_send,
    ...
    .migrate_dispatcher_request = monitor_migrate_dispatcher_request__loopback_send,
    ...
    .migrate_dispatcher = monitor_migrate_dispatcher__loopback_send,
};
/*
 * Control functions
 */
